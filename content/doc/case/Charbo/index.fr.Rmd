...
Modèle "déversoir rectangulaire avec encoche triangulaire", menu déroulant

équation

variable "hauteur d'eau" : $h$

comparaison des courbes de tarage a priori

paramètres a priori / a posteriori

comparaison des courbes de tarage a posteriori
