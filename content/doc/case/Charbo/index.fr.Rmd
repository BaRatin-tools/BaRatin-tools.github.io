...
<p style="text-align: center;color: gray;"> Figure 1. Analyse des contrôles hydrauliques pour le ruisseau de Charbonnières à Charbonnières-Les-Bains. Gauche: photo prise depuis l'aval, avec vue du déversoir "triangle tronqué" inséré dans un déversoir rectangulaire plus large; droite: schéma d'un déversoir de type "triangle tronqué".</p>
