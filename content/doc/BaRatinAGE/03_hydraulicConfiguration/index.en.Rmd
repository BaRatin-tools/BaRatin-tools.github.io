...
The *prior* parameters of a 'Q=f(h)' hydraulic configuration are specified by directly defining the parameter distributions, as for the *k-a-c parameters* mode of a standard hydraulic configuration. The next steps, up to the calculation of the posterior rating curve and the discharge series, are the same as when using a standard hydraulic configuration.
