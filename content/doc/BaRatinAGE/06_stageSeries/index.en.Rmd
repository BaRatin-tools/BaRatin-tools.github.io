...
A stage series (or *limnigraph*) is a time series of water levels.

By default, a stage series named *Ht (1)* pre-exists and can be used. There are several ways of creating a new stage series:

- via the menu *Components...Create new limnigraph*;
- by right-clicking on the <img src="limnigraph.svg" style="display:inline-block"> *Limnigraph* node in the Component Explorer tree;
...
All that remains is to import the stage series file by clicking on the *Import a limnigraph* button, selecting the text file of your choice and specifying its format. The stage series file is a free-format text file, but it must contain at least five columns with the following data:
