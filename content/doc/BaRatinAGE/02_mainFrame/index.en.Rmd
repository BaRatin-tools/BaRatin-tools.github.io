...
- *Preferences*: preferences for the appearance and behaviour of BaRatinAGE that can be saved between sessions (language, dark mode, font size, icon size, hide BaM console outputs, close this window if BaM terminates successfully).
