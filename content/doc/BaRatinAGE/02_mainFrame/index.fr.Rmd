...
-   *Préférences* : préférences sur l'apparence et le comportement de BaRatinAGE pouvant être sauvegardées entre sessions de travail (langue, mode sombre, taille de police, taille des icônes, cacher les sorties de la console de BaM, fermer cette fenêtre si BaM termine sans erreur).
