...
BaRatinAGE est un logiciel permettant d'estimer des courbes de tarage ainsi que leurs incertitudes, et de propager ces incertitudes aux hydrogrammes. La méthode est basée sur une [analyse hydraulique](/fr/doc/topics/analyse-hydraulique) de la station hydrométrique et sur l'[estimation bayésienne](/fr/doc/topics/bayesien) de la courbe de tarage. BaRatinAGE est l'acronyme de BAyesian RATINg curve Advanced Graphical Environment.
