...
-   en effectuant un clic droit sur le noeud <img src="XXX.svg" style="display:inline-block"> *Outils* dans l'arborescence de l'Explorateur des composants, puis sélectionner *Comparateur de courbes de tarage* ;
-   en cliquant sur le bouton <img src="XXX_add.svg" style="display:inline-block"> dans la barre d'outils.
