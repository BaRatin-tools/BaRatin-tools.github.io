...
Une description plus formelle et plus complète des modèles d'*erreur structurelle*, et plus généralement des modèles statistiques utilisés dans BaRatinAGE, est disponible dans **ce document** XX LIEN? XX.
