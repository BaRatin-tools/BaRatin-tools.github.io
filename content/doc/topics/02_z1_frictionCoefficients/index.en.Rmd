...
The flow resistance parameters (or friction coefficients) of channel controls are often difficult to determine precisely.
In engineering practice, they are often expressed as Strickler coefficient $K_S$ or Manning coefficient $n$, one being the inverse of the other ($n=1/K_S$).
...
Other interesting references on friction factor estimation include:
