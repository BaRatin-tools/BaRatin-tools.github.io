...
* $\nu_2$ = the opening angle of the triangle of the sill (in degrees)
...
The Manning-Strickler formula is applied to a circular channel: the case of uniform open-channel flow, not pipe flow, in a canal, pipe or duct of circular cross-section, with radius $r$ and bottom elevation $b$. 
...
* $b$ = the channel bottom elevation
* $K_S$ = the flow resistance coefficient (Strickler coefficient in m$^{1/3}.$s$^{-1}$)
