...
<p style="text-align: center;color: gray;"> Figure 5: chenal rectangulaire large : vue en long (à gauche) et section en travers à l'échelle (à droite). </p>
...
<p style="text-align: center;color: gray;"> Figure 6: chenal parabolique large : vue en long (à gauche) et section en travers à l'échelle (à droite). </p>
...
<p style="text-align: center;color: gray;"> Figure 7: chenal triangulaire : vue en long (à gauche) et section en travers à l'échelle (à droite). </p>
...
$$Q(H) = K_S \sqrt{S_0} \frac{\left[B_r (H-b) + m (H-b)^2 \right]^{c+1}}{\left[B_r + 2 (H-b) \sqrt{1+m^2} \right]^{c}} $$
...
* $S_0$ = la pente longitudinale du chenal autour de la station (sans unité, il faut saisir
0.01 pour 1%, etc.)
...
$$Q(H) = K_S \sqrt{S_0} \frac{r^{8/3}}{2^{2/3}} {\rm acos}(1-\frac{H}{r}) \left[ 1- \frac{{\rm sin}(2{\rm acos}(1-\frac{H}{r}))}{2{\rm acos}(1-\frac{H}{r})} \right]^{c+1} $$
si $b < H\leq b+r$.

$$Q(H) = K_S \sqrt{S_0} \frac{r^{8/3}}{2^{2/3}} \left[ \pi - {\rm acos}(\frac{H}{r}-1) \right] \left[ 1+ \frac{{\rm sin}(2{\rm acos}(\frac{H}{r}-1))}{2\pi - 2{\rm acos}(\frac{H}{r}-1)} \right]^{c+1} $$
si $b+r < H < b+2r$.
